    ...
    228: function (t, e, r) {
      ...
      t.exports = (function () {
        ...
        var b = function (t, e, r, i, l) {
          var n;
          if ((void 0 === i && (i = !0), void 0 === l && (l = !1), "top" === e))
            n = [
              "contentHeight",
              "containerHeight",
              "scrollTop",
            ...
            (t.reach[a] = null),
              ...
              e &&
                ...
                e < 0
                  ...
                  : e > 0 && f.dispatchEvent(p("ps-scroll-" + d)),
                i &&
                  (function (t, e) {
                    c(t, e), h(t, e);
                  })(t, a)),
              t.reach[a] &&
                (e || l) &&
                f.dispatchEvent(p("ps-" + a + "-reach-" + t.reach[a]));
          })(t, r, n, i, l);
        };
        function g(t) {
          ...
          m = function (t) {
            ...
            (t.containerWidth = r.clientWidth),
              ...
              r.contains(t.scrollbarXRail) ||
                (o(r, s.element.rail("x")).forEach(function (t) {
                  return n(t);
                }),
                r.appendChild(t.scrollbarXRail)),
              r.contains(t.scrollbarYRail) ||
                (o(r, s.element.rail("y")).forEach(function (t) {
                  return n(t);
                }),
                  ...
                  (t.settings.suppressScrollX && 0 !== o) ||
                    ...
                    (function (r, i) {
                      ...
                      if (0 === r) {
                        ...
                        if (
                          (0 === l && i > 0) ||
                          (l >= t.contentHeight - t.containerHeight && i < 0)
                        )
                      ...
                      if (0 === i) {
                        ...
                        if (
                          (0 === n && r < 0) ||
                          (n >= t.contentWidth - t.containerWidth && r > 0)
                        )
                          return !t.settings.wheelPropagation;
                      }
                      return !0;
                ...
                if (
                  !(function (e, i, l) {
                    ...
                    for (var n = e; n && n !== r; ) {
                      ...
                      var o = t(n),
                        a = [o.overflow, o.overflowX, o.overflowY].join("");
                  ...
                  e.settings.useBothWheelAxes
                    ? e.scrollbarYActive && !e.scrollbarXActive
                      ? (o
                          ...
                          : (r.scrollTop += n * e.settings.wheelSpeed),
                        (a = !0))
                      : e.scrollbarXActive &&
                        !e.scrollbarYActive &&
                        (n
                          ? (r.scrollLeft += n * e.settings.wheelSpeed)
                  ...
                  g > 0 && ((n.x = f / g), (n.y = p / g), (l = b)),
                    (function (t, i) {
                      ...
                      if (s > o) {
                        if (
                          (i < 0 &&
                            l === e.contentHeight - e.containerHeight) ||
                          (i > 0 && 0 === l)
                        )
                          return 0 === window.scrollY && i > 0 && v.isChrome;
                      } else if (
                        o > s &&
                        ((t < 0 && n === e.contentWidth - e.containerWidth) ||
                          (t > 0 && 0 === n))
                      )
                        return !0;
                      return !0;
