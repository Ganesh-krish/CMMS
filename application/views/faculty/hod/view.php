                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <a href="<?php echo base_url($url.'/management/hod/add'); ?>" class="btn btn-primary">
                                    <i class="feather icon-plus"></i> Add Dept Administrator
                                </a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($hods as $hod): ?>
                                            <tr>
                                                ...
                                                <td><?php echo htmlspecialchars($hod['phone_number']); ?></td>
                                                <td>
                                                    <?php
                                                    if (isset($hod['department_id']) && $hod['department_id']) {
                                                        $dept = $this->db_model->get_row(TABLE_DEPARTMENT, ["id" => $hod['department_id']]);
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="<?php echo base_url($url.'/management/hod/edit/'.$hod['id']); ?>">
                                                                <i class="feather icon-edit"></i> Edit
                                                            </a>
                                                            <a class="dropdown-item text-danger" href="#" onclick="confirmDelete(<?php echo $hod['id']; ?>, '<?php echo htmlspecialchars($hod['name']); ?>')">
...
function confirmDelete(id, name) {
    if (confirm('Are you sure you want to delete the department administrator "' + name + '"? This action cannot be undone.')) {
        window.location.href = '<?php echo base_url($url.'/management/hod/delete/'); ?>' + id;
    }
}
</script>