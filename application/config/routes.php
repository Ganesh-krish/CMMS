...
$route['(:any)/principal/edit_hod/(:num)'] = 'faculty/Principal/edit_hod/$2';
$route['(:any)/principal/delete_hod/(:num)'] = 'faculty/Principal/delete_hod/$2';
$route['(:any)/principal/staff'] = 'faculty/Principal/staff';
$route['(:any)/principal/add_staff'] = 'faculty/Principal/add_staff';
$route['(:any)/principal/edit_staff/(:num)'] = 'faculty/Principal/edit_staff/$2';
$route['(:any)/principal/delete_staff/(:num)'] = 'faculty/Principal/delete_staff/$2';
$route['(:any)/principal/add_student'] = 'faculty/Principal/add_student';
$route['(:any)/principal/edit_student/(:num)'] = 'faculty/Principal/edit_student/$2';
$route['(:any)/principal/delete_student/(:num)'] = 'faculty/Principal/delete_student/$2';
...
$route['(:any)/principal/batch_dept'] = 'faculty/Principal/batch_dept';
...
$route['(:any)/principal/add_batch'] = 'faculty/Principal/add_batch';
$route['(:any)/principal/edit_batch/(:num)'] = 'faculty/Principal/edit_batch/$2';
$route['(:any)/principal/delete_batch/(:num)'] = 'faculty/Principal/delete_batch/$2';
