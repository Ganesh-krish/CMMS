    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="card p-2">
            ...
            border-bottom-width: 1px;">
                ...
                <div>
                    <a href="<?= base_url($url.'/course/new') ?>" class="btn btn-primary mr-3">Add Course</a>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                                <a href="<?= base_url($url.'/course/modules/'.$row['id']); ?>" class="btn btn-primary btn-sm" ><i class="feather icon-layers"></i>&nbsp;Modules </a>
