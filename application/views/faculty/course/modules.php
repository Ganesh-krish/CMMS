...
<div class="layout-content <?= $courseModeClass?>">
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="card p-2 mb-4">
            ...
            border-radius: 0.125rem 0.125rem 0 0; 
            border-bottom-width: 1px;">
                <h6 class="card-header" style="border:none">Add Module</h6>
            </div>
            <div class="card-body">
                <form action="<?= base_url($url.'/course/add_module') ?>" method="post">
                            ...
                            <div class="card mb-2">
                                <div class="card-header" id="heading<?= $module['id'] ?>">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="btn-group">
                                            <a href="<?= base_url($url.'/course/module_tests/'.$course['id'].'/'.$module['id']) ?>" 
