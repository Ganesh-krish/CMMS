...
|
*/
// Base URLs for unified CMMS (update production URL when deploying)
$config['base_url']   = (ENVIRONMENT !== 'production') ? 'http://localhost/CMMS/' : 'https://your-prod-domain/';
$config['college_url'] = $config['base_url'];
$config['student_url'] = (ENVIRONMENT !== 'production') ? 'http://localhost/CMMS/' : 'https://your-prod-domain/';
