!(function (t, e) {
  var n = (function (t) {
    ...
    305: function (t, e, n) {
      "use strict";
      var i = $.fn.tagsinput.Constructor.prototype.build,
        a = $.fn.tagsinput.Constructor.prototype.destroy;
      ($.fn.tagsinput.Constructor.prototype.build = function (t) {
        ...
        (this.$inpWidth = $(
          ...
          $(
            '<div style="position:absolute;width:0;height:0;z-index:-100;opacity:0;overflow:hidden;"></div>'
          )
            .append(this.$inpWidth)
            .prependTo(this.$container);
        var o = function (t) {
          return (
            Math.ceil(
              e.$inpWidth.html((t || "").replace(a, "#")).outerWidth() + 12
            ) + "px"
          );
        };
        return (
          (this.$input[0].style.width = o()),
        ...
        ($.fn.tagsinput.Constructor.prototype.destroy = function () {
          return (
            this.$input.off("keydown keyup focusout paste change"), a.call(this)
          );
        }),
        $(function () {
          $(
      ...
      !(function (t) {
        ...
        (n.prototype = {
          ...
          add: function (e, n, i) {
            ...
            if (
              !(
                a.options.maxTags && a.itemsArray.length >= a.options.maxTags
              ) &&
              (!1 === e || e)
            ) {
              if (
                ("string" == typeof e && a.options.trimValue && (e = t.trim(e)),
                "object" == typeof e && !a.objectItems)
              )
              ...
              if (!e.toString().match(/^\s*$/)) {
                if (
                  (a.isSelect &&
                    !a.multiple &&
                    a.itemsArray.length > 0 &&
                    a.remove(a.itemsArray[0]),
                  "string" == typeof e && "INPUT" === this.$element[0].tagName)
                ) {
                  var o = a.options.delimiterRegex
                      ? a.options.delimiterRegex
                      : a.options.delimiter,
                    s = e.split(o);
                  if (s.length > 1) {
                ...
                if (!d || a.options.allowDuplicates) {
                  if (
                    ...
                    if ((a.$element.trigger(f), !f.cancel)) {
                      ...
                      var v =
                        t(
                          'option[value="' + encodeURIComponent(l) + '"]',
                          a.$element
                        ).length ||
                        t('option[value="' + r(l) + '"]', a.$element).length;
                      if (a.isSelect && !v) {
                        var g = t("<option selected>" + r(p) + "</option>");
                        g.data("item", e),
                          g.attr("value", l),
                          a.$element.append(g);
                      }
                      n || a.pushVal(),
                        (a.options.maxTags !== a.itemsArray.length &&
                          a.items().toString().length !==
                            a.options.maxInputLength) ||
                          a.$container.addClass("bootstrap-tagsinput-max"),
                        t(".typeahead, .twitter-typeahead", a.$container)
                          .length && a.$input.typeahead("val", ""),
                        this.isInit
                          ? a.$element.trigger(
                              t.Event("itemAddedOnInit", {
                                item: e,
                                options: i,
                              })
                            )
                          : a.$element.trigger(
                              t.Event("itemAdded", { item: e, options: i })
                            );
                    }
                  }
            ...
            if (
              ...
              t(".tag", a.$container)
                ...
                t("option", a.$element)
                  ...
                  .remove(),
                -1 !== t.inArray(e, a.itemsArray) &&
                  a.itemsArray.splice(t.inArray(e, a.itemsArray), 1);
            }
            n || a.pushVal(),
              a.options.maxTags > a.itemsArray.length &&
                a.$container.removeClass("bootstrap-tagsinput-max"),
              a.$element.trigger(
                t.Event("itemRemoved", { item: e, options: i })
              );
          },
          removeAll: function () {
            for (
              t(".tag", this.$container).remove(),
                t("option", this.$element).remove();
          ...
          build: function (n) {
            var o = this;
            if (
              ((o.options = t.extend({}, e, n)),
              o.objectItems && (o.options.freeInput = !1),
              i(o.options, "itemValue"),
              i(o.options, "itemText"),
              a(o.options, "tagClass"),
              o.options.typeahead)
            ) {
            ...
            if (o.options.typeaheadjs) {
              var u = null,
                l = {},
                p = o.options.typeaheadjs;
              t.isArray(p) ? ((u = p[0]), (l = p[1])) : (l = p),
                o.$input.typeahead(u, l).on(
                  "typeahead:selected",
                  t.proxy(function (t, e) {
                    l.valueKey ? o.add(e[l.valueKey]) : o.add(e),
                      o.$input.typeahead("val", "");
                  }, o)
                );
            }
            o.$container.on(
              "click",
              t.proxy(function (t) {
                o.$element.attr("disabled") || o.$input.removeAttr("disabled"),
                  o.$input.focus();
              }, o)
            ),
              o.options.addOnBlur &&
                ...
                o.$input.on(
                  ...
                  t.proxy(function (e) {
                    0 ===
                      t(".typeahead, .twitter-typeahead", o.$container)
                        .length && (o.add(o.$input.val()), o.$input.val(""));
                  }, o)
                ),
              o.$container.on(
                "keydown",
                ...
                t.proxy(function (e) {
                  ...
                  if (o.$element.attr("disabled"))
                    ...
                    var i,
                      ...
                      r,
                      s = n.val(),
                      u = o.options.maxChars && s.length >= o.options.maxChars;
                    o.options.freeInput &&
                      ((i = e),
                      (a = o.options.confirmKeys),
                      (r = !1),
                      t.each(a, function (t, e) {
                        if ("number" == typeof e && i.which === e)
                          return (r = !0), !1;
                        if (i.which === e.which) {
                          var n =
                              !e.hasOwnProperty("altKey") ||
                              i.altKey === e.altKey,
                            a =
                      ...
                      r || u) &&
                      (0 !== s.length &&
                        (o.add(u ? s.substr(0, o.options.maxChars) : s),
                        n.val("")),
                      !1 === o.options.cancelConfirmKeysOnEmpty &&
                        e.preventDefault());
                    var l = n.val().length;
                    Math.ceil(l / 5),
                      n.attr("size", Math.max(this.inputSize, n.val().length));
              ...
              o.$container.on(
                ...
                "[data-role=remove]",
                t.proxy(function (e) {
                  o.$element.attr("disabled") ||
                    o.remove(t(e.target).closest(".tag").data("item"));
                }, o)
              ),
              o.options.itemValue === e.itemValue &&
                ("INPUT" === o.$element[0].tagName
                  ? o.add(o.$element.val())
                  : t("option", o.$element).each(function () {
