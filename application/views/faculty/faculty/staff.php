                            ...
                            foreach ($staff as $row) {  $no++?>
                                <tr>
                                    ...
                                    <td class="d-flex gap-1" style="flex-wrap: wrap;">
                                        <a href="<?= base_url($url.'/hod/staff/edit/'.$row['id']) ?>" class="btn btn-sm btn-info">Edit</a>
                                        <a href="<?= base_url($url.'/hod/staff/delete/'.$row['id']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this staff?');">Delete</a>
